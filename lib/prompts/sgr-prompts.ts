...
Расшифровка с таймкодами даётся в формате «ЧЧ:ММ:СС — текст». Пользователь должен иметь возможность **вручную проверить каждый факт** по времени.

- **Формат:** только один момент времени на маркер: [ТС: ЧЧ:ММ:СС] (как в строке расшифровки). Пример: [ТС: 00:12:34].
...
### Один раздел — одно сообщение (ЖЁСТКО)
