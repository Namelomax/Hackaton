...
- Извлекай термины с определениями; минимум 3–5; у каждого утверждения — свой [ТС: ЧЧ:ММ:СС].
...
- Список сокращений; у каждого пункта при возможности — [ТС: …].
...
ВАЖНО: Активно ищи в расшифровке: названия систем, продуктов, процессов, технические понятия, профессиональный жаргон.
Если термин упоминается, но не объясняется — предложи своё определение на основе контекста и попроси подтвердить.
Не говори «термины не указаны» — обязательно предложи хотя бы 3–5 терминов из контекста встречи.
