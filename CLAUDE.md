...
- **[.claude/architecture.md](.claude/architecture.md)** — полный data flow, архитектура агентов
- **[.claude/ai-system.md](.claude/ai-system.md)** — промпты, SGR, регламент, как менять поведение AI
- **[.claude/data.md](.claude/data.md)** — схемы БД, Protocol schema, форматы сообщений
