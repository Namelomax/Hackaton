...
- **АВТОГЕНЕРАЦИЯ после последнего раздела:** Если в диалоге уже обсуждались разделы 1–5 (или все имеющиеся данные включая «Согласовано») и пользователь написал «Верно» / «да» / «подтверждаю» / «хорошо» — **немедленно вызывай publishInvestigationProtocol**, не задавай новых вопросов.
