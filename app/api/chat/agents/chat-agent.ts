...
- ТАЙМ-КОДЫ: ${PROTOCOL_TIMECODE_ADAPTATION_LINE} Пример: «00:02:47 — … Никита Касьянов, представитель Форус» → «…Форус [ТС: 00:02:47].» Без [ТС: …] в ответе по расшифровке недопустимо. В финальный документ тайм-коды НЕ попадают.
